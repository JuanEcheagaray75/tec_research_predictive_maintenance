...
\begin{document}
    ...
    \section{Introduction}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{intro_maintenance.jpg}
                \end{figure}
                \begin{center}
    ...
    \section{Objectives}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{objectives_path.jpg}
                \end{figure}
                \begin{center}
    ...
    \section{Exploratory Data Analysis}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{eda_puzzle.jpg}
                \end{figure}
                \begin{center}
    ...
    \section{Methodology}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{methodology_blueprint.jpg}
                \end{figure}
                \begin{center}
        ...
        \subsection{Feature Extraction}
            ...
            \begin{frame}{Feature Extraction}{TSS Basics}
                ...
                \begin{figure}[!htbp]
                    \centering
                    \includegraphics[scale=0.35]{sample_breakpoints.png}
    ...
    \section{Experimental Results}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{results.jpg}
                \end{figure}
                \begin{center}
        ...
        \begin{frame}{Baseline Regression Models}
            ...
            A suite of ML models is fit to 80\% of a PCA processed dataset \footnote{See Table \ref{tab:raw_baseline} to compare model performances with raw data}, tested on the remaining 20\% (no GPU/TPU):
            \begin{table}[!htbp]
                \scalebox{0.6}{
    ...
    \section{Conclusions and Future Work}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{conclusion.jpg}
                \end{figure}
                \begin{center}
    ...
    \section*{Q\&A}

        {
            ...
            \begin{frame}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.7\columnwidth]{qa_question_mark.jpg}
                \end{figure}
                \begin{center}
                    \textit{Questions?}
                \end{center}
    ...
    \appendix
    \begin{frame}{Raw Baseline Comparison}
        \begin{table}[]
            \scalebox{0.6}{
            \begin{tabular}{lrrrrr}
                \hline
            ...
            \caption{Comparison of model performance without PCA}
